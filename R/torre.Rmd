...
This tutorial demonstrates the R package [`cpam`](https://l-a-yates.github.io/cpam/) for the analysis of time series
...
names with the time points (here expressed in hours).
...
For this analysis, the count data are supplied as a matrix (see this [case study](https://raw.githack.com/l-a-yates/cpam_manuscript/main/R/crisp.html) for importing data directly from common quantification software). We keep all transcripts
that have more than 20 reads in at least 3/5 of the samples. 
...
cpo
```
If you run the code on your own computer, you can launch the Shiny app to 
visualise the results interactively using `visualise(cpo)`.
